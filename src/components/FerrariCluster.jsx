...
export default function FerrariCluster({
  ...
  // height prop no longer controls layout; we clamp to 520px to prevent overflow
...
function FerrariRPMGauge({ value = 5200, min = 0, max = 9000, sizeCSS = "280px" }) {
  ...
  return (
    <svg viewBox="0 0 200 200" style={{ width: sizeCSS, height: sizeCSS, overflow: "hidden" }} aria-label="RPM">
      <defs>
...
function FerrariSpeedGauge({ value = 70, min = 0, max = 220, sizeCSS = "300px" }) {
  ...
  return (
    <svg viewBox="0 0 220 220" style={{ width: sizeCSS, height: sizeCSS, overflow: "hidden" }} aria-label="Speed">
