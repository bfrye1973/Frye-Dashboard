...
export default function FullChart() {
  ...
  return (
    <div style={{ height: vh, display: "flex", flexDirection: "column", background: "#0a0a0a" }}>
      {/* Header bar */}
      <div style={{
        display: "flex", alignItems: "center", gap: 8, padding: "10px 12px",
        borderBottom: "1px solid #2b2b2b", background: "#0f0f0f"
      }}>
        <button
      ...
      <div style={{ flex: 1, minHeight: 0 }}>
        <RowChart
          ...
          defaultTimeframe={tf}
          height={vh - 52 /* header height approx */}
          showDebug={false}
        />
      </div>
    </div>
