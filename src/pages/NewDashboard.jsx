...
/* Row 5 — Strategies (3 tiles; you’ll wire it) */
function StrategiesRow() {
  return (
    <div id="row-5" className="panel">
      <div className="panel-head">
...
/* Page wrapper — stacks 7 rows in order */
export default function NewDashboard() {
  return (
    <div style={{ padding: 12, display: "grid", gap: 12 }}>
      ...
      <EngineLights />
      <IndexSectors />
      <StrategiesRow />   {/* Row 5 (you’ll wire it) */}
      <ChartSection />    {/* Row 6 */}
      <JournalPanel />    {/* Row 7 */}
    </div>
  );
