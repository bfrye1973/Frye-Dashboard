...
export default function RowModeToggle() {
  ...
  function buildAiTradeCopilotText(ai) {
    ...
    return [
      ...
      reasoning.confidenceNote ? `Confidence note: ${reasoning.confidenceNote}.` : "",
  ...
  async function onListenAI() {
    ...
    try {
      ...
      const text = buildAiTradeCopilotText(ai);
      setAiText(text);
      ...
      <div className="panel-head" style={{ alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <button
            ...
            title="Read ES AI Trade Copilot"
          >
