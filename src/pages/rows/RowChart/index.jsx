  ...
  return (
    <div style={{ flex:1, minHeight:0, overflow:"hidden", background:"#0a0a0a", border:"1px solid #2b2b2b", borderRadius:12, display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:"0 0 auto", display:"flex", justifyContent:"flex-end", padding:"6px 12px", borderBottom:"1px solid #2b2b2b" }}>
        <button onClick={() => window.open(`/chart?symbol=${state.symbol}&tf=${state.timeframe}`, "_blank", "noopener")}
      ...
      <div className="chart-shell" style={{ flex:"1 1 auto", minHeight:0, display:"flex", flexDirection:"column" }}>
        <div ref={containerRef} className="tv-lightweight-charts"
             style={{ position:"relative", width:"100%", height:"100%", minHeight:0, flex:1 }} data-cluster-host>
          {ind.moneyFlow && (
