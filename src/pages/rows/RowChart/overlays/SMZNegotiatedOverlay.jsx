...
// Engine 1 Overlay — NEGOTIATED/VALUE ZONES ONLY (turquoise)
// Renders ABOVE institutional (yellow) so yellow always shows underneath.
//
// Contract:
...
export default function SMZNegotiatedOverlay({
  ...
  // Negotiated styling (turquoise)
  // IMPORTANT: Fill must stay semi-transparent so yellow shows underneath.
  const NEG_FILL = "rgba(0,220,200,0.10)";
  const NEG_BORDER = "rgba(0,220,200,0.95)";
  const NEG_BORDER_W = 1;

  // Keep dashed midline (as before)
  const SHOW_MID = true;
  ...
  function ensureCanvas() {
    ...
    Object.assign(cnv.style, {
      ...
      inset: 0,
      pointerEvents: "none",
      // Negotiated layer ABOVE institutional
      zIndex: 13,
    });
