...
export default function RowMarketOverview(){
  ...
  const tdSdyDaily=Number.isFinite(num(dd?.metrics?.squeeze_daily_pct))?num(dd.metrics.squeeze_daily_pct):NaN;
  ...
  return(
    <section id="row-2" className="panel" style={{padding:10}}>
      ...
      {/* ------------------- Legends ------------------- */}
      {legendOpen && (
        <div role="dialog" aria-modal="true" onClick={()=>setLegendOpen(null)}
          ...
          <div onClick={(e)=>e.stopPropagation()}
            ...
            <div style={{display:"flex",justifyContent:"flex-end",marginTop:12}}>
              <button onClick={()=>setLegendOpen(null)}
