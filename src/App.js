        ...
        <div>
          ...
          <div style={panel}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "6px 0" }}>
              ...
              />
              <label htmlFor="ema10" style={{ fontSize: 12, opacity: 0.85 }}>
                EMA 10
              </label>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "6px 0" }}>
              ...
              />
              <label htmlFor="ema20" style={{ fontSize: 12, opacity: 0.85 }}>
                EMA 20
              </label>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "6px 0" }}>
              ...
              />
              <label htmlFor="mfp" style={{ fontSize: 12, opacity: 0.85 }}>
                Money Flow Profile
              </label>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "6px 0" }}>
              ...
              />
              <label htmlFor="sr" style={{ fontSize: 12, opacity: 0.85 }}>
                Support / Resistance
              </label>
            </div>
          </div>
        ...
        >
          <LiveLWChart
            ...
            indicatorSettings={{
              ...
              sr: { left: 15, right: 15, volumeThresh: 20 }, // ✅ basic SR params
            }}
          />
        </div>
      </div>
