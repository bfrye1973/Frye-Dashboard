...
export default function App() {
  ...
  // indicator settings (overrides only if you want)
  ...
  // build active indicator list from toggles
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0d1117", color: "#d1d4dc" }}>
      ...
      >
        FEED: <strong>{dbg.source}</strong> • bars: <strong>{dbg.bars}</strong> •
        shape: <strong>{dbg.shape}</strong> • url:{" "}
          ...
          <div style={panel}>
            ...
            <div style={checkRow}>
              <input
                ...
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, ema10: e.target.checked }))
                }
              />
              <label htmlFor="ema10" style={small}>
                EMA 10
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                ...
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, ema20: e.target.checked }))
                }
              />
              <label htmlFor="ema20" style={small}>
                EMA 20
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                ...
                checked={enabled.mfp}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, mfp: e.target.checked }))
                }
              />
              <label htmlFor="mfp" style={small}>
                Money Flow Profile
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                ...
                checked={enabled.sr}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, sr: e.target.checked }))
                }
              />
              <label htmlFor="sr" style={small}>
                Support / Resistance
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                id="swing"
                type="checkbox"
                checked={enabled.swing}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, swing: e.target.checked }))
                }
              />
              <label htmlFor="swing" style={small}>
                Swing Points & Liquidity
              </label>
            </div>

            <hr style={{ borderColor: "#1f2a44", margin: "8px 0" }} />

            <div style={checkRow}>
              <input
                id="squeeze"
                type="checkbox"
                checked={enabled.squeeze}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, squeeze: e.target.checked }))
                }
              />
              <label htmlFor="squeeze" style={small}>
                Squeeze (LuxAlgo)
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                ...
                checked={enabled.smi}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, smi: e.target.checked }))
                }
              />
              <label htmlFor="smi" style={small}>
                SMI
              </label>
            </div>
            ...
            <div style={checkRow}>
              <input
                ...
                checked={enabled.vol}
                onChange={(e) =>
                  setEnabled((p) => ({ ...p, vol: e.target.checked }))
                }
              />
              <label htmlFor="vol" style={small}>
                Volume
              </label>
            </div>
