...
/* Context: central /api/dashboard fetch + last-good fallback */
import { DashboardDataProvider } from "./context/DashboardDataContext";

/* Rows (all kept under ./components for now) */
...
export default function App() {
  ...
  /* --- simple UI styles for this page --- */
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(3, 1fr)", gap:8 }}>
            ...
            <div className="panel" style={panel}>
              ...
              <div style={{ display:"flex", gap:6, flexWrap:"wrap" }}>
                {["1m","10m","1H","1D"].map(tf => (
                  <button key={tf} style={btn(timeframe.toLowerCase()===tf.toLowerCase())}
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:6 }}>
                {[
                  ...
                  <label key={id} style={{ display:"flex", alignItems:"center", gap:6 }}>
                    <input type="checkbox" checked={!!enabled[id]}
